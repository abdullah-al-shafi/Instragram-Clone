 ...
 * @ManyToOne
 * 
 * @Column(name = "posts_Id") private Posts posts;
 * 
 *//**
	* 
	*/
 ...
 *//**
	 ...
	 * @param posts
	 *//*
		 * public Reaction(long reactionId, User reactedUser, Posts posts) { super();
		 * this.reactionId = reactionId; this.reactedUser = reactedUser; this.posts =
		 * posts; }
		 * 
		 ...
		 * 
		 * public User getReactedUser() { return reactedUser; }
		 * 
		 * public void setReactedUser(User reactedUser) { this.reactedUser =
		 * reactedUser; }
		 * 
		 ...
		 * 
		 * @Override public String toString() { return "Reaction [reactionId=" +
		 * reactionId + ", reactedUser=" + reactedUser + ", posts=" + posts + "]"; }
		 * 
		 * 
		 * 
		 * 
