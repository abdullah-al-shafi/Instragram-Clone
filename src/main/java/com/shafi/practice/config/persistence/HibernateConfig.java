package com.shafi.practice.config.persistence;
...
@EnableJpaRepositories("com.shafi.practice.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.shafi.practice.model");
                for (Class<?> clazz : (new Reflections("com.shafi.practice.model")).getTypesAnnotatedWith(Entity.class)) {
